...
app.get("/contact/*", (req,res) => {
    ...
    res.render('headers', { errorcomemnt : 'This contact Page not found' , } );  // helpful for which file run 
    
});

app.get("*", (req,res) => {
    
    res.render('headers', { errorcomemnt : 'Page not found' , } );  // helpful for which file run 
